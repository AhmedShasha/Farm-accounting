                            ...
                            <div class="col-12 col-md-6 order-md-2 d-flex justify-content-end">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">إضافة رأس المال</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="col-12 m-auto">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">إضافة رأس المال</h4>
                                    </div>
                                    <div class="card-content">
                                        @include('includes.errors')

                                        <div class="card-body">
                                            <form class="form" method="POST" action="{{ route('storeFirst_lastPeriod') }}">
                                                @csrf
                                                {{ csrf_field() }}
                                                {{ method_field('post') }}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4 col-6">
                                                        ...
                                                        <select name="periodStatus" id="periodStatus" class="choices form-select"
                                                            ...
                                                            <option value="0"
                                                                {{ old('periodStatus') == '0'? 'selected' : '' }}>
                                                                أول المدة</option>
                                                            <option value="1"
                                                                {{ old('periodStatus') == '1'? 'selected' : '' }}>
                                                                أخر المدة</option>
                                                        </select>
                                                    </div>
