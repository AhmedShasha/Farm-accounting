                            ...
                            <div class="col-12 col-md-6 order-md-2 d-flex justify-content-end">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">رأس مال اخر المدة</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <span class="col-md-6">رأس مال اخر المدة</span>
                                    <div class="col-md-6 text-start">
                                        <a href="{{ route('createFirst_LastPeriod') }}" class="btn btn-sm btn-success">
                                            إضافة
                                ...
                                <table class="table table-striped" id="table1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">السعر الاجمالى</th>

                                            <th class="text-center">الاكشن</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($data['lastP'] as $index => $value)
                                            <tr>
                                                ...
                                                <td class="text-center"style="width:fit-content;">
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('editFirst_LastPeriod', $value->id) }}"><i
                                                            class="fas fa-edit mr-1"></i></a>
                                                    <form action="{{ route('deleteFirst_LastPeriod', $value->id) }}" method="POST"
