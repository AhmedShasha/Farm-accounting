        ...
        <div id="auth">
            ...
            <div class="row h-100">
                <div class="col-md-7 col-12 m-auto">
                    <div id="auth-left">
                        <div class="auth-logo mb-3 row">
                            <a href="" class="col-1"><img src="{{ asset('dist/assets/images/logo/logo.png') }}"
                                    alt="Logo"></a>
                            <h1 class="auth-title  col-6 text-end">المزرعة</h1>

                        </div>
                        {{-- <p class="auth-subtitle mb-3" style="margin-left: 25px"></p> --}}

                        @auth
                            <p class="text-secondary font-bold auth-subtitle mb-3">
                                {{ Auth::user()->name }} مرحبا بعودتك</p>
                            <a href="{{ url('/home') }}" class="btn btn-outline-primary  font-bold m-auto">
                        ...
                        @else
                            <form method="POST" action="" class="col-md-12 mt-5">
                                ...
                                <div class="col-10  text-start">
                                    <button type="submit" class="btn btn-primary font-bold col-4" id="submit">
                                        دخول
                                    </button>
